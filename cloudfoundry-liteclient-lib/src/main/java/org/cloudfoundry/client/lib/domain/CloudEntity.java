...
public class CloudEntity {
	...
	public static class Meta {
		...
		public Meta(JSONObject meta) throws JSONException {
			this(UUID.fromString(meta.getString("guid")),
					ResponseObject.parseDate(meta.get("created_at")),
					ResponseObject.parseDate(meta.get("updated_at")));
		}
