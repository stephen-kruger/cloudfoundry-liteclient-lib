...
public class CloudFoundryClientTest {
	private static String user, password, target;
	static {
		try {
...
//	private static final String CCNG_API_URL = System.getProperty("ccng.target", "http://api.run.pivotal.io");
	private static final String CCNG_API_URL = System.getProperty("ccng.target", target);
...
//	private static final String CCNG_USER_EMAIL = System.getProperty("ccng.email", "java-authenticatedClient-test-user@vmware.com");
	private static final String CCNG_USER_EMAIL = user;

	private static final String CCNG_USER_PASS = password;//System.getProperty("ccng.passwd");
	...
	@Test
	public void createApplication() throws CloudFoundryException {
	...
	@Test
	public void createApplicationWithBuildPack() throws IOException, CloudFoundryException {
	...
	@Test
	public void createApplicationWithHealthCheckTimeout() throws IOException, CloudFoundryException {
	...
	@Test
	public void createApplicationWithDomainOnly() throws CloudFoundryException {
	...
	@Test
	public void getApplicationByName() throws CloudFoundryException {
	...
	@Test
	public void getApplicationByGuid() throws CloudFoundryException {
	...
	@Test
	public void getApplicationNonExistent() throws CloudFoundryException {
	...
	@Test
	public void getApplications() throws CloudFoundryException {
		final String serviceName = "test_database";
	...
	@Test
	public void deleteApplication() throws CloudFoundryException {
	...
	@Test
	public void startStopApplication() throws IOException, CloudFoundryException {
	...
	@Test
	public void paginationWorksForUris() throws IOException, CloudFoundryException {
	...
	@Test
	public void setEnvironmentThroughList() throws IOException, CloudFoundryException {
	...
	@Test
	public void setEnvironmentWithoutEquals() throws IOException, CloudFoundryException {
	...
	@Test
	public void setEnvironmentThroughMap() throws IOException, CloudFoundryException {
	...
	@Test
	public void updateApplicationDisk() throws IOException, CloudFoundryException {
	...
	@Test
	public void updateApplicationMemory() throws IOException, CloudFoundryException {
	...
	@Test
	public void updateApplicationUris() throws IOException, CloudFoundryException {
	...
	@Test
	public void uploadStandaloneApplication() throws IOException, CloudFoundryException {
	...
	@Test
	public void uploadStandaloneApplicationWithURLs() throws IOException, CloudFoundryException {
	...
	@Test
	public void updateStandaloneApplicationCommand() throws IOException, CloudFoundryException {
		String appName = namespacedAppName("standalone-ruby");
		List<String> uris = new ArrayList<String>();
		List<String> services = new ArrayList<String>();
		createStandaloneRubyTestApp(appName, uris, services);
	...
	@Test
	public void renameApplication() throws CloudFoundryException {
	...
	@Test
	public void createAndReCreateApplication() throws CloudFoundryException {
	...
	@Test
	public void getApplicationsMatchGetApplication() throws CloudFoundryException {
	...
	private void waitForStatsAvailable(String appName, int instanceCount) throws InterruptedException, CloudFoundryException {
	...
	@Test
	public void getApplicationStatsStoppedApp() throws IOException, CloudFoundryException {
		String appName = namespacedAppName("stats2");
	...
	@Test
	public void uploadAppWithNonAsciiFileName() throws IOException, CloudFoundryException {
	...
	@Test
	public void startExplodedApplication() throws IOException, CloudFoundryException {
	...
	@Test
	public void getServiceOfferings() throws CloudFoundryException {
	...
	@Test
	public void getCreateDeleteService() throws MalformedURLException, CloudFoundryException {
	...
	@Test
	public void getServices() throws CloudFoundryException {
	...
	@Test
	public void getService() throws CloudFoundryException {
		String serviceName = "mysql-test";
	...
	@Test
	public void getServiceWithVersionAndProvider() throws CloudFoundryException {
	...
	@Test
	public void createApplicationWithService() throws IOException, CloudFoundryException {
	...
	@Test
	public void deleteServiceThatIsBoundToApp() throws MalformedURLException, CloudFoundryException {
	...
	@Test
	public void updateApplicationService() throws IOException, CloudFoundryException {
		String serviceName = "test_database";
		createMySqlService(serviceName);
	...
	@Test
	public void bindAndUnbindService() throws IOException, CloudFoundryException {
		String serviceName = "test_database";
		createMySqlService(serviceName);
	...
	@Test
	public void getDomains() throws CloudFoundryException {
		connectedClient.addDomain(TEST_DOMAIN);
	...
	@Test
	public void addAndDeleteDomain() throws CloudFoundryException {
		connectedClient.addDomain(TEST_DOMAIN);
	...
	private void assertDomainInList(List<CloudDomain> domains) throws CloudFoundryException {
		assertTrue(domains.size() >= 1);
		assertNotNull(getDomainNamed(TEST_DOMAIN, domains));
	}

	private void assertDomainNotInList(List<CloudDomain> domains) throws CloudFoundryException {
		assertTrue(domains.size() >= 1);
	...
	private void doGetFile(CloudFoundryClient client, String appName) throws Exception {
		...
		try {
			...
			assertTrue(e.getStatusCode()==HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE.ordinal());
		}
	...
	private CloudApplication createAndUploadSimpleTestApp(String name) throws IOException, CloudFoundryException {
	...
	private String createSpringTravelApp(String suffix) throws CloudFoundryException {
		return createSpringTravelApp(suffix, null);
	}

	private String createSpringTravelApp(String suffix, List<String> serviceNames) throws CloudFoundryException {
		String appName = namespacedAppName("travel_test-" + suffix);
		createSpringApplication(appName, serviceNames);
		return appName;
	}

	private CloudApplication uploadSpringTravelApp(String appName) throws IOException, CloudFoundryException {
		File file = SampleProjects.springTravel();
		connectedClient.uploadApplication(appName, file.getCanonicalPath());
	...
	private CloudApplication createAndUploadExplodedSpringTestApp(String appName)
			throws IOException, CloudFoundryException {
	...
	private CloudApplication createAndUploadAndStartSimpleSpringApp(String appName) throws IOException, CloudFoundryException {
		createAndUploadSimpleSpringApp(appName);
		connectedClient.startApplication(appName);
		return connectedClient.getApplication(appName);
	}

	private CloudApplication createAndUploadSimpleSpringApp(String appName) throws IOException, CloudFoundryException {
		createSpringApplication(appName);
	...
	private void createStandaloneRubyTestApp(String appName, List<String> uris, List<String> services) throws IOException, CloudFoundryException {
	...
	private void createSpringApplication(String appName) throws CloudFoundryException {
		createTestApp(appName, null, new Staging());
	}

	private void createSpringApplication(String appName, List<String> serviceNames) throws CloudFoundryException {
		createTestApp(appName, serviceNames, new Staging());
	}

	private void createSpringApplication(String appName, String buildpackUrl) throws CloudFoundryException {
	...
	private void createTestApp(String appName, List<String> serviceNames, Staging staging) throws CloudFoundryException {
		List<String> uris = new ArrayList<String>();
		uris.add(computeAppUrl(appName));
	...
	private CloudServiceOffering getCloudServiceOffering(String label) throws CloudFoundryException {
	...
	private InstancesInfo getInstancesWithTimeout(CloudFoundryClient client, String appName) throws CloudFoundryException {
	...
	private void clearTestDomainAndRoutes() throws CloudFoundryException {
